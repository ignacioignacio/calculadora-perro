    ...
    const budgetFlow = {
        ...
        snack_adapt_duracion: {
            ...
            options: {
                ...
                snack_adapt_duracion_2: { label: "2 adaptaciones de duración", percentage: 0.1, next: "snack_formatos" },
        ...
        snack_adapt_formato: {
            ...
            options: {
                ...
                snack_adapt_formato_2: { label: "2 adaptaciones de formato", percentage: 0.15, next: "snack_voz_off" },
        ...
        snack_voz_off: {
            ...
            type: 'radio',
            options: {
                snack_voz_off_si: { label: "Con voz en off", percentage: 0.5, next: "snack_entrenamiento" },
        ...
        story_adapt_duracion: {
            ...
            options: {
                ...
                story_adapt_duracion_2: { label: "2 adaptaciones de duración", percentage: 0.1, next: "story_formatos" },
        ...
        story_adapt_formato: {
            ...
            options: {
                ...
                story_adapt_formato_2: { label: "2 adaptaciones de formato", percentage: 0.1, next: "story_lipsync" },
        ...
        story_actor_referencia: {
            ...
            type: 'radio',
            options: {
                story_actor_referencia_si: { label: "Con actor de referencia", percentage: 0.5, next: "entrega_crudos" },
