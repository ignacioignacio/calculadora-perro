...
export default function App() {
    ...
    // --- FLOW CONFIGURATION ---
    // Each option now has its own percentage or fixedAmount.
    const budgetFlow = {
        start: {
            question: "Elegí el tipo de contenido",
            type: 'radio',
            options: {
                snack: { label: "Snack Content", description: "Ideal para contenido rápido y directo.", next: "snack_cantidad" },
        ...
        snack_cantidad: {
            ...
            type: 'radio',
            options: {
                snack_cantidad_1: { label: "1 pieza", percentage: 0 },
                snack_cantidad_2: { label: "2 piezas", percentage: -0.07 },
                snack_cantidad_3: { label: "3 piezas", percentage: -0.10 },
                snack_cantidad_4: { label: "4 piezas", percentage: -0.12 }
            },
            next: "snack_entrega"
        },
        snack_entrega: {
            ...
            options: {
                ...
                snack_entrega_periodos: { label: "Por períodos", percentage: 0 }
            }
        },
        snack_duracion: {
            question: "Duración",
            ...
            options: {
                ...
                snack_duracion_30: { label: "30 segundos", percentage: 0 }
            }
        },
        snack_adapt_duracion: {
            ...
            options: {
                ...
                snack_adapt_duracion_2: { label: "2 adaptaciones", percentage: 0.30 }
            }
        },
        snack_formatos: {
            question: "Formatos",
            ...
            options: {
                ...
                snack_formatos_1_1: { label: "1:1 / 4:5", percentage: 0 },
                snack_formatos_16_9: { label: "16:9", percentage: 0 }
            }
        },
        snack_adapt_formato: {
            ...
            options: {
                ...
                snack_adapt_formato_2: { label: "2 adaptaciones", percentage: 0.30 }
            }
        },
        snack_voz_off: {
            ...
            options: {
                ...
                snack_voz_off_no: { label: "Sin voz en off", percentage: 0 }
            }
        },
        snack_entrenamiento: {
            ...
            options: {
                ...
                snack_entrenamiento_no: { label: "Sin entrenamiento", percentage: 0 }
            }
        },
        story_duracion: {
            question: "Duración",
            ...
            options: {
                ...
                story_duracion_30: { label: "30 segundos", percentage: 0 }
            }
        },
        story_adapt_duracion: {
            ...
            options: {
                ...
                story_adapt_duracion_2: { label: "2 adaptaciones", percentage: 0.30 }
            }
        },
        story_formatos: {
            question: "Formatos",
            ...
            options: {
                ...
                story_formatos_1_1: { label: "1:1 / 4:5", percentage: 0 },
                story_formatos_16_9: { label: "16:9", percentage: 0 }
            }
        },
        story_adapt_formato: {
            question: "Adaptaciones de formato",
            ...
            options: {
                ...
                story_adapt_formato_2: { label: "2 adaptaciones", percentage: 0.30 }
            }
        },
        story_lipsync: {
            ...
            options: {
                ...
                story_lipsync_2: { label: "2 actores", percentage: 0.70 }
            }
        },
        story_entrenamiento: {
            question: "Entrenamiento de producto",
            ...
            options: {
                ...
                story_entrenamiento_no: { label: "Sin entrenamiento", percentage: 0 }
            }
        },
        story_actor_referencia: {
            ...
            options: {
                ...
                story_actor_referencia_no: { label: "Sin actor", percentage: 0 }
            }
        },
        entrega_crudos: {
            ...
            options: {
                ...
                entrega_crudos_no: { label: "Sin crudos", percentage: 0 }
            }
        },
        guion_creativo: {
            ...
            options: {
                ...
                guion_creativo_no: { label: "Sin guión", percentage: 0 }
            }
        },
        concepto_creativo: {
            ...
            options: {
                ...
                concepto_creativo_no: { label: "Sin concepto", percentage: 0 }
            }
        },
        end: { isFinal: true }
    };
    ...
    const currentStepId = useMemo(() => {
        ...
        const next = budgetFlow[last.selection]?.next;
        return next || 'end';
    }, [path]);
    ...
    const totalPrice = useMemo(() => {
        ...
        path.forEach(p => {
            ...
            if (opt.percentage) total += base * opt.percentage;
        });
        return Math.floor(total);
    }, [path]);

    // ... (rendering and handlers remain unchanged) 
}
